...
namespace SCZM.DAL.Base
{
	...
	public partial class base_ProcedureMachineNat
	{
		...
		/// 增加一条数据
		/// </summary>
		public int Add(SCZM.Model.Base.base_ProcedureMachineNat model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into base_ProcedureMachineNat(");
		...
		/// 更新一条数据
		/// </summary>
		public int Update(SCZM.Model.Base.base_ProcedureMachineNat model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update base_ProcedureMachineNat set ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 ID,ProcedureId,MachineLevel10,MachineLevel20,MachineLevel30,MachineLevel40,MachineLevel50,NumType,FlagDel,OperaId,OperaName,OperaTime from base_ProcedureMachineNat ");
			strSql.Append(" where FlagDel=0 and ID=@ID ");
			SqlParameter[] parameters = {
				new SqlParameter("@ID", SqlDbType.Int,4)};
		...
		/// </summary>
		public SCZM.Model.Base.base_ProcedureMachineNat DataRowToModel(DataRow row)
		{
			SCZM.Model.Base.base_ProcedureMachineNat model=new SCZM.Model.Base.base_ProcedureMachineNat();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update base_ProcedureMachineNat set FlagDel=1 ");
		...
		public DataSet GetList(string strWhere)
		{
            ...
            //strSql.Append("FROM base_ProcedureMachineNat a ");
            ...
            strSql.Append("left join base_ProcedureMachineNat b on b.ProcedureId=a.ID and b.FlagDel=0 ");
            strSql.Append("where a.FlagDel=0");
			if (strWhere.Trim() != "")
			{
