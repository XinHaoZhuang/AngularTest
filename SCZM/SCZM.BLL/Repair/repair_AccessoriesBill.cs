...
{
    /// <summary>
    /// 业务逻辑类repair_AccessoriesBill 的摘要说明。
    /// </summary>
    public partial class repair_AccessoriesBill
    {
        private readonly SCZM.DAL.Repair.repair_AccessoriesBill dal = new SCZM.DAL.Repair.repair_AccessoriesBill();
        ...
        /// 增加一条数据
        /// </summary>
        public int Add(SCZM.Model.Repair.repair_AccessoriesBill model, out string message)
        {
            message = "保存成功！";
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(SCZM.Model.Repair.repair_AccessoriesBill model, out string message)
        {
            message = "保存成功！";
