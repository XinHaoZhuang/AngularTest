...
{
    /// <summary>
    /// 业务逻辑类repair_ReceiveFee 的摘要说明。
    /// </summary>
    public partial class repair_ReceiveFee
    {
        private readonly SCZM.DAL.Repair.repair_ReceiveFee dal = new SCZM.DAL.Repair.repair_ReceiveFee();
        ...
        /// 增加一条数据
        /// </summary>
        public int Add(SCZM.Model.Repair.repair_ReceiveFee model, out string message)
        {
            message = "保存成功！";
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(SCZM.Model.Repair.repair_ReceiveFee model, out string message)
        {
            message = "保存成功！";
