...
{
    /// <summary>
    /// 业务逻辑类base_SettlementType 的摘要说明。
    /// </summary>
    public partial class base_SettlementType
    {
        private readonly SCZM.DAL.Base.base_SettlementType dal = new SCZM.DAL.Base.base_SettlementType();
        ...
        /// 增加一条数据
        /// </summary>
        public int Add(SCZM.Model.Base.base_SettlementType model, out string message)
        {
            message = "保存成功！";
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(SCZM.Model.Base.base_SettlementType model, out string message)
        {
            message = "保存成功！";
