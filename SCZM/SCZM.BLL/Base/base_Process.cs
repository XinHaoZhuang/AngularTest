...
{
    /// <summary>
    /// 业务逻辑类base_Process 的摘要说明。
    /// </summary>
    public partial class base_Process
    {
        private readonly SCZM.DAL.Base.base_Process dal = new SCZM.DAL.Base.base_Process();
        public base_Process()
        { }
        #region  基本方法
        /// <summary>
        /// 增加一条数据
        /// </summary>
        public int Add(SCZM.Model.Base.base_Process model, out string message)
        {
            message = "保存成功！";
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(SCZM.Model.Base.base_Process model, out string message)
        {
            message = "保存成功！";
