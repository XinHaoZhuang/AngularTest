...
{
    /// <summary>
    /// 业务逻辑类base_RepairType 的摘要说明。
    /// </summary>
    public partial class base_RepairType
    {
        private readonly SCZM.DAL.Base.base_RepairType dal = new SCZM.DAL.Base.base_RepairType();
        ...
        /// 增加一条数据
        /// </summary>
        public int Add(SCZM.Model.Base.base_RepairType model, out string message)
        {
            message = "保存成功！";
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(SCZM.Model.Base.base_RepairType model, out string message)
        {
            message = "保存成功！";
