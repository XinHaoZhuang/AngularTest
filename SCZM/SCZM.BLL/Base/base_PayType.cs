...
{
    /// <summary>
    /// 业务逻辑类base_PayType 的摘要说明。
    /// </summary>
    public partial class base_PayType
    {
        private readonly SCZM.DAL.Base.base_PayType dal = new SCZM.DAL.Base.base_PayType();
        public base_PayType()
        { }
        #region  基本方法
        /// <summary>
        /// 增加一条数据
        /// </summary>
        public int Add(SCZM.Model.Base.base_PayType model, out string message)
        {
            message = "保存成功！";
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(SCZM.Model.Base.base_PayType model, out string message)
        {
            message = "保存成功！";
        ...
        {
            return dal.GetPayTypeCombo(strWhere);
        }
        #endregion  扩展方法
    }
}
