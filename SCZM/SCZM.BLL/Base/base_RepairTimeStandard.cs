...
{
	/// <summary>
	/// 业务逻辑类base_RepairTimeStandard 的摘要说明。
	/// </summary>
	public partial class base_RepairTimeStandard
	{
		private readonly SCZM.DAL.Base.base_RepairTimeStandard dal=new SCZM.DAL.Base.base_RepairTimeStandard();
		...
		/// 增加一条数据
		/// </summary>
		public int  Add(SCZM.Model.Base.base_RepairTimeStandard model, out string message)
		{
			message = "保存成功！";
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(SCZM.Model.Base.base_RepairTimeStandard model,out string message)
		{
			message = "保存成功！";
