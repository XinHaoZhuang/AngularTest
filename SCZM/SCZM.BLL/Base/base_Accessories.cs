...
{
    /// <summary>
    /// 业务逻辑类base_Accessories 的摘要说明。
    /// </summary>
    public partial class base_Accessories
    {
        private readonly SCZM.DAL.Base.base_Accessories dal = new SCZM.DAL.Base.base_Accessories();
        ...
        /// 增加一条数据
        /// </summary>
        public int Add(SCZM.Model.Base.base_Accessories model, out string message)
        {
            message = "保存成功！";
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(SCZM.Model.Base.base_Accessories model, out string message)
        {
            message = "保存成功！";
        ...
        {
           return dal.GetAccessoriesCombo(strWhere);
        }
        #endregion  扩展方法
    }
}
