...
{
    /// <summary>
    /// 业务逻辑类base_PartnerType 的摘要说明。
    /// </summary>
    public partial class base_PartnerType
    {
        private readonly SCZM.DAL.Base.base_PartnerType dal = new SCZM.DAL.Base.base_PartnerType();
        ...
        /// 增加一条数据
        /// </summary>
        public int Add(SCZM.Model.Base.base_PartnerType model, out string message)
        {
            message = "保存成功！";
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(SCZM.Model.Base.base_PartnerType model, out string message)
        {
            message = "保存成功！";
