...
{
    /// <summary>
    /// 业务逻辑类base_Settlement 的摘要说明。
    /// </summary>
    public partial class base_Settlement
    {
        private readonly SCZM.DAL.Base.base_Settlement dal = new SCZM.DAL.Base.base_Settlement();
        ...
        /// 增加一条数据
        /// </summary>
        public int Add(SCZM.Model.Base.base_Settlement model, out string message)
        {
            message = "保存成功！";
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(SCZM.Model.Base.base_Settlement model, out string message)
        {
            message = "保存成功！";
        ...
        {
            return dal.GetSettlementTypeCombo(strWhere);
        }
        #endregion  扩展方法
    }
}
