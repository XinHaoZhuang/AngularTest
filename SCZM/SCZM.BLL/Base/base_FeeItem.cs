...
{
    /// <summary>
    /// 业务逻辑类base_FeeItem 的摘要说明。
    /// </summary>
    public partial class base_FeeItem
    {
        private readonly SCZM.DAL.Base.base_FeeItem dal = new SCZM.DAL.Base.base_FeeItem();
        public base_FeeItem()
        { }
        #region  基本方法
        /// <summary>
        /// 增加一条数据
        /// </summary>
        public int Add(SCZM.Model.Base.base_FeeItem model, out string message)
        {
            message = "保存成功！";
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(SCZM.Model.Base.base_FeeItem model, out string message)
        {
            message = "保存成功！";
        ...
        {
            return dal.GetFeeItemCombo(strWhere);
        }
        #endregion  扩展方法
    }
}
