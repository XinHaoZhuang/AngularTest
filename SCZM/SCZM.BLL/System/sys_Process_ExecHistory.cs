...
{
    /// <summary>
    /// 业务逻辑类sys_Process_ExecHistory 的摘要说明。

    /// </summary>
    public partial class sys_Process_ExecHistory
    {
        private readonly SCZM.DAL.System.sys_Process_ExecHistory dal = new SCZM.DAL.System.sys_Process_ExecHistory();
        ...
        /// </summary>
        public int Add(SCZM.Model.System.sys_Process_ExecHistory model, out string message)
        {
            message = "新增成功！";
        ...
        /// </summary>
        public bool Update(SCZM.Model.System.sys_Process_ExecHistory model, out string message)
        {
            message = "修改成功！";
        ...
        /// </summary>
        public SCZM.Model.System.sys_Process_ExecHistory GetModelByCache(int ID)
        {

            string CacheKey = "sys_Process_ExecHistoryModel-" + ID;
            ...
            return (SCZM.Model.System.sys_Process_ExecHistory)objModel;
        }
        ...
        /// 获得数据列表
        /// </summary>
        public List<SCZM.Model.System.sys_Process_ExecHistory> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<SCZM.Model.System.sys_Process_ExecHistory> DataTableToList(DataTable dt)
        {
            List<SCZM.Model.System.sys_Process_ExecHistory> modelList = new List<SCZM.Model.System.sys_Process_ExecHistory>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                SCZM.Model.System.sys_Process_ExecHistory model;
