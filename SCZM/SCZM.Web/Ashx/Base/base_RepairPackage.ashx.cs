...
{
    /// <summary>
    /// base_RepairPackage 的摘要说明
    /// <summary>
    public class base_RepairPackage : IHttpHandler, IReadOnlySessionState
    {
        public void ProcessRequest(HttpContext context)
        {
            ...
            switch (action)
            {
                case "GetList": //获取维修套包列表
                    GetList(context, btn);
                    break;
                case "GetDetail": //获取维修套包明细
                    GetDetail(context, btn);
                    break;
                case "SaveData": //保存维修套包信息
                    SaveData(context, btn);
                    break;
                case "DelData": //删除维修套包信息
                    DelData(context, btn);
                    break;
            }
        }
        ...
        private void GetList(HttpContext context, string btn)
        {
            ...
            try
            {
                ...
                SCZM.BLL.Base.base_RepairPackage bll = new SCZM.BLL.Base.base_RepairPackage();
        ...
        private void SaveData(HttpContext context, string btn)
        {
            ...
            string PackageName = RequestHelper.GetString("PackageName");
