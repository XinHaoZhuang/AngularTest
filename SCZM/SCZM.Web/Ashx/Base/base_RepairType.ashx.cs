...
{
    /// <summary>
    /// base_RepairType 的摘要说明
    /// <summary>
    public class base_RepairType : IHttpHandler, IReadOnlySessionState
    {
        public void ProcessRequest(HttpContext context)
        {
            ...
            switch (action)
            {
                case "GetList": //获取维修类型列表
                    GetList(context, btn);
                    break;
                case "GetDetail": //获取维修类型明细
                    GetDetail(context, btn);
                    break;
                case "SaveData": //保存维修类型信息
                    SaveData(context, btn);
                    break;
                case "DelData": //删除维修类型信息
                    DelData(context, btn);
                    break;
            }
        }
        ...
        private void GetList(HttpContext context, string btn)
        {
            ...
            try
            {
                ...
                SCZM.BLL.Base.base_RepairType bll = new SCZM.BLL.Base.base_RepairType();
        ...
        private void SaveData(HttpContext context, string btn)
        {
            ...
            string RepairTypeName = RequestHelper.GetString("RepairTypeName");
            ...
            model.RepairTypeName = RepairTypeName;
